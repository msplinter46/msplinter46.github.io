...
#Contabilizar total de artigos para preencher parâmetro retmax do Entrez.esearch
...
record_results = open("Artigos PubMed.txt", 'w')
lang={'eng':'English', 'fre':'French', 'rus':'Russian', 'ger':"German", "spa":"Spanish", "pol":"Polish", "jpn":"Japanese"}
record_results.write ("Legionella pneumophila subsp. pneumophila str. Philadelphia 1\n\n")
record_results.write('Artigos Disponiveis em PubMed a '+ time.strftime("%d/%m/%Y")+'\n')
record_results.write('Total de artigos disponiveis:' + str(len(records)) + '\n\n')
...
for record in records:
    ...
    record_results.write(lin1)
    record_results.write(lin2)
    record_results.write(lin3)
    record_results.write(lin4)
    record_results.write(lin5)
    record_results.write("\n\n")
record_results.close()



handle2 = Entrez.esearch(db = "pubmed", term = "Legionella  pneumophila Philadelphia 1  L-threonine", retmax=total)#restringir à estirpe Philadelphia 1
...
record_results2 = open("Artigos PubMed_tirosina.txt", 'w')
lang={'eng':'English', 'fre':'French', 'rus':'Russian', 'ger':"German", "spa":"Spanish", "pol":"Polish", "jpn":"Japanese"}
